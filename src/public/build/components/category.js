...
export function category(category) {
  ...
  return (subContainer.innerHTML += `
        <article class="category flex justify-around items-end w-[50vh] h-[35vh] bg-cover bg-center hover:scale-105 shadow-xl shadow-yellow-300 md:shadow-2xl md:shadow-yellow-300 cursor-pointer" style="background-image: url(${category.image})" id="${category.id_category}">
            <h1>${category.name}</h1>
